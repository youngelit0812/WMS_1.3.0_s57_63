...
public:
  ...
  bool RenderQuiltRegionViewOnDCNoText(wxMemoryDC &dc, ViewPort &vp, OCPNRegion &chart_region, bool bCSShowFlag = true, bool bLHShowFlag = true, bool bBUOYShowFlag = true, bool bLDESCRShowFlag = true, bool bAIShowFlag = true, bool bSlvisShowFlag = true);
...
private:
  ...
  bool DoRenderQuiltRegionViewOnDC(wxMemoryDC &dc, ViewPort &vp, OCPNRegion &chart_region, bool bCSShowFlag = true, bool bLHShowFlag = true, bool bBUOYShowFlag = true, bool bLDESCRShowFlag = true, bool bAIShowFlag = true, bool bSlvisShowFlag = true);
