...
public:
  ...
  virtual bool RenderRegionViewOnDCNoText(wxMemoryDC &dc, const ViewPort &VPoint, const OCPNRegion &Region, bool bCSShowFlag = true, bool bLHShowFlag = true, bool bBUOYShowFlag = true, bool bLDESCRShowFlag = true, bool bAIShowFlag = true, bool bSlvisShowFlag = true);
...
private:
  ...
  bool DoRenderViewOnDC(wxMemoryDC &dc, const ViewPort &VPoint, RenderTypeEnum option, bool force_new_view, bool bCSShowFlag = true, bool bLHShowFlag = true, bool bBUOYShowFlag = true, bool bLDESCRShowFlag = true, bool bAIShowFlag = true, bool bSlvisShowFlag = true);

  bool DoRenderRegionViewOnDC(wxMemoryDC &dc, const ViewPort &VPoint, const OCPNRegion &Region, bool b_overlay, bool bCSShowFlag = true, bool bLHShowFlag = true, bool bBUOYShowFlag = true, bool bLDESCRShowFlag = true, bool bAIShowFlag = true, bool bSlvisShowFlag = true);

  int DCRenderRect(wxMemoryDC &dcinput, const ViewPort &vp, wxRect *rect, bool bCSShowFlag = true, bool bLHShowFlag = true, bool bBUOYShowFlag = true, bool bLDESCRShowFlag = true, bool bAIShowFlag = true, bool bSlvisShowFlag = true);
  bool DCRenderLPB(wxMemoryDC &dcinput, const ViewPort &vp, wxRect *rect, bool bCSShowFlag = true, bool bLHShowFlag = true, bool bBUOYShowFlag = true, bool bLDESCRShowFlag = true, bool bAIShowFlag = true, bool bSlvisShowFlag = true);
  ...
  int m_nvaldco; //depth contour value cnt
  int m_nvaldco_alloc;
  double *m_pvaldco_array;  //depth contour value array
