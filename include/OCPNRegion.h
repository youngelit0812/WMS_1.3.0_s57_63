...
public:
  ...
  wxRegionContain Contains(const wxPoint& xPoint) const {
    return ODoContainsPoint(xPoint.x, xPoint.y);
  }
...
public:
  ...
  bool Offset(const wxPoint& xPoint) { return ODoOffset(xPoint.x, xPoint.y); }
