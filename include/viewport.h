...
public:
  ...
  LLRegion GetLLRegion(const OCPNRegion &region); //get LLRegion of region that contains in this viewport
  ...
  double clon;
  double view_scale_ppm; // chart's scale in pixel per meter
  double skew;
  double rotation;
